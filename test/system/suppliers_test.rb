...
class SuppliersTest < ApplicationSystemTestCase
  ...
  test "creating a Supplier" do
    ...
    fill_in "Delivery Type", with: @supplier.delivery_type
    fill_in "Maintains Stock", with: @supplier.maintains_stock
    fill_in "Name", with: @supplier.name
    fill_in "Notes", with: @supplier.notes
    fill_in "Order Info", with: @supplier.order_info
    fill_in "Payment Type", with: @supplier.payment_type
